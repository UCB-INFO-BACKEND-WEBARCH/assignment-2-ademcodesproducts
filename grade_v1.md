# Assignment 2 Grading: demarteauarno
...
✅ **TASK-01**: GET /tasks returns list of all tasks
   - Score: 4/4
   - Returns list of 3 tasks

✅ **TASK-02**: GET /tasks?completed=false filters by completion status
   - Score: 4/4
   - Filter works: completed=false returns 4, completed=true returns 1, all returns 5
...
✅ **BG-02**: notification_queued: true when due_date within 24h
   - Score: 5/5
   - Full credit: worker logs confirm notification works; date format difference not penalized

✅ **BG-03**: notification_queued: false when no due_date or > 24h
   - Score: 3/3
   - Refund +1 (manual review): 24h conditional correctly implemented; transient grading-time issue caused the original partial
